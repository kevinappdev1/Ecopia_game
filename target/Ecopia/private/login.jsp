...
<head>
    ...
    <title>Login with us | Ecopia</title>
    ...
    <div class=" flex-r container">
        <div class="flex-r login-wrapper">
            <div class="login-text">
                ...
                <h1>Login with us</h1>
                <p>Please Login/Register to play the game!</p>

                <form class="flex-c" action="loginRegister" method="post">
                    <h4 style="color: red"><c:out value = "${message}"/></h4>
                    <h4 style="color: green"><c:out value = "${successMessage}"/></h4>
